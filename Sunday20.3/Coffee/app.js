...
function renderOrder() {
  ...
  for (let i = 0; i < banana.length; i++) {
    ...
    return parElement.textContent = `this customer ${banana[i].cusName} he order the following ${banana[i].cupSize} with ${banana[i].milkType} and he prefare is ${hot} in ${banana[i].drinkType} and the price ${banana[i].price} `;
  }
